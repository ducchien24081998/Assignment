...
var ranNumber = Math.round(Math.random() * 10**5);
...
var randomNum: number = Math.floor(Math.random()*10**5);
var stringNum: string = randomNum.toString().padStart(5, "0");
console.log("so ngau nhien co 5 chu so: ", stringNum);
console.log("----------------------------------------------------------------");

console.log("question3");
var lastNum: string = stringNum.slice(3);
